<?php
	...
	if (isset($_POST["sendText"])) {
		if (isset($_POST["message"]) && $_POST["message"] !== "") {
			...
			$insertquery = "INSERT INTO groupchat (name,content,fromUsername,datetime) VALUES ('$groupchatName','$content','$username',now())";
	...
	$selectquery = "SELECT * FROM groupchat WHERE name='$groupchatName' ORDER BY datetime DESC";
...
<html>
	<head>
		...
		<title>
			<?php echo $groupchatName ?> | FSConnect
		</title>
